...
Collects information from all markdown files, PRs, Issues, and Discussions within
selected repositories on the Interlisp GitHub site:  `github.com/Interlisp`
...
curl -X POST \
  ...
  -H "Content-Type: application/json" \
  -H "x-goog-user-project: interlispsearch" \
  "https://discoveryengine.googleapis.com/v1/projects/interlispsearch/locations/global/collections/default_collection/dataStores?dataStoreId=interlisp-github-v2" \
  -d '{
...
In addition, we need to set the schema for the data store.  The schema is used to define the data types of the various elements used to represent GitHub entries:
...
curl -X PATCH \
  ...
  -H "Content-Type: application/json" \
  -H "x-goog-user-project: interlispsearch" \
  "https://discoveryengine.googleapis.com/v1/projects/interlispsearch/locations/global/collections/default_collection/dataStores/interlisp-github/schemas/default_schema" \
  -d '{
    "structSchema": {
      "$schema": "https://json-schema.org/draft/2020-12/schema",
      "type": "object",
      "properties": {
        "id":           { "type": "string", "indexable": true },
        "title":        { "type": "string", "keyPropertyMapping": "title" },
        "content":      { "type": "string", "indexable": true },
        "url":          { "type": "string", "keyPropertyMapping": "uri" },
        "type":         { "type": "string", "indexable": true },
        "repo":         { "type": "string", "indexable": true },
        "state":        { "type": "string", "indexable": true },
        "author":       { "type": "string", "indexable": true },
        "labels": {
          "type": "array",
          "items": { "type": "string", "indexable": true }
        },
        "created_at":   { "type": "string", "format": "date-time", "indexable": true },
        "updated_at":   { "type": "string", "format": "date-time", "indexable": true },
        "number":       { "type": "integer", "indexable": true }
      }
    }
  }'
```

### 2.2 Add Target Sites
...
curl -X POST \
  ...
  -H "Content-Type: application/json" \
  -H "x-goog-user-project: interlispsearch" \
  "https://discoveryengine.googleapis.com/v1/projects/interlispsearch/locations/global/collections/default_collection/engines?engineId=interlisp-search-v3" \
  -d '{
    "displayName": "Interlisp Search",
    "solutionType": "SOLUTION_TYPE_SEARCH",
    "industryVertical": "GENERIC",
    "dataStoreIds": [
      "interlisp-site-search",
      "interlisp-github-v2"
    ],
    "searchEngineConfig": {
...
3. Fill in details:
   - App name: `interlisp-search-v3`
   - Company name: `interlisp.org`
   - Location: `global`
4. Select data store: `interlisp-site-search`
5. Note the generated engine ID: `interlisp-search-v3`
...
gcloud functions deploy search \
  ...
  --set-env-vars PROJECT_ID=interlispsearch,ENGINE_ID=interlisp-search-v3,ALLOWED_ORIGIN=https://interlisp.org \
  --memory=256Mi \
  --timeout=30s \
  --project=interlispsearch
```
...
# New work to integrate into document
...
```bash
# Run the extraction
GITHUB_TOKEN=your_token node scripts/github-index.js

# Upload to Cloud Storage
gcloud storage cp github-index.jsonl gs://interlisp-document-bucket/github-index.jsonl
...
-H "Content-Type: application/json" \
-H "x-goog-user-project: interlispsearch" \
"https://discoveryengine.googleapis.com/v1/projects/interlispsearch/locations/global/collections/default_collection/dataStores/interlisp-github-v2/branches/0/documents:import" \
-d '{
"gcsSource": {
"inputUris": ["gs://interlisp-document-bucket/github-index.jsonl"],
"dataSchema": "document"
},
